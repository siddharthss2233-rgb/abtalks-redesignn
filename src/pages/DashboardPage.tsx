        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 animate-fade-up">
          <div className="flex items-center gap-4">
            <img
              ...
              className="w-14 h-14 rounded-2xl object-cover ring-2 ring-brand-400/30"
            />
            <div>
          ...
          {[
            {
              icon: Clock,
              label: "Watch Time",
              value: currentUser.totalWatchTime,
              ...
              {[
                ...
                >
                  <div className="w-full max-w-[42px] h-full flex items-end">
                    <div
                      className="w-full rounded-t-xl gradient-brand transition-all duration-700 hover:opacity-80"
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <h3
                        className="font-semibold text-sm line-clamp-2 group-hover:text-brand-500 transition-colors"
                        style={{ color: "var(--text-primary)" }}
                      >
                        {course.title}
                      </h3>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="glass rounded-2xl p-6 space-y-4">
              ...
              <div
                className="flex items-center gap-6 pb-4 border-b"
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <p
                              className="text-sm font-medium truncate group-hover:text-brand-500 transition-colors"
                              style={{ color: "var(--text-primary)" }}
                            >
                              {course.title}
                            </p>
                            <span className="text-xs font-semibold text-brand-500 ml-2 shrink-0">
                              {pct}%
                            </span>
                          </div>
                          <div
