  ...
  if (!course) {
    return (
      <div className="pt-32 pb-20 text-center">
        ...
        <Link to="/explore" className="text-brand-500 font-medium">
          Back to Explore
        </Link>
      </div>
    );
  ...
  return (
    <div className="pt-20 pb-12 min-h-screen">
      ...
      <div className="relative h-[40vh] sm:h-[50vh] overflow-hidden">
        ...
        />
        <div
          className={`absolute inset-0 bg-gradient-to-t ${course.color} opacity-50 mix-blend-multiply`}
        />
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6">
            ...
            <h1
              className="text-2xl sm:text-4xl font-bold text-white tracking-tight max-w-3xl animate-fade-up"
              style={{ animationDelay: "0.1s" }}
            >
              {course.title}
            </h1>
            <p
              className="mt-2 text-white/80 text-lg max-w-2xl animate-fade-up"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4 relative">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass rounded-2xl p-4 flex flex-wrap items-center justify-between gap-3 animate-fade-up">
              <div className="flex items-center gap-3">
                ...
                >
                  <Bookmark
                    className={`w-5 h-5 ${bookmarked ? "fill-white" : ""}`}
                  />
                </button>
                <button
                  className="p-2.5 rounded-xl border transition-colors hover:border-brand-400/50"
                  style={{
                    borderColor: "var(--border-color)",
                    color: "var(--text-secondary)",
                  }}
            ...
            >
              ...
              {progress && (
                <div
                  className="mb-4 h-2 rounded-full overflow-hidden"
                ...
                {course.lessons.map((lesson, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isOpen && (
                        <div
                          className="px-4 pb-4 pl-12 text-sm animate-fade-in"
                          style={{ color: "var(--text-secondary)" }}
                        >
                          In this lesson, {course.speaker.name} explores{" "}
                          {lesson.title.toLowerCase()} with practical examples
                          and real-world insights. You will gain actionable
          ...
          <div className="space-y-6">
            ...
            {/* Certificate */}
            <div
              className="relative overflow-hidden rounded-2xl gradient-brand p-6 text-white animate-fade-up"
              style={{ animationDelay: "0.2s" }}
            >
              ...
              <p className="text-sm text-white/80 mt-1">
                Complete all lessons to earn a verified certificate of
                completion.
              </p>
            </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="px-2 py-1 rounded-md bg-emerald-500/10 text-emerald-500 text-[10px] font-bold">
                  96% MATCH
                </span>
              </div>
              ...
              >
                ...
                <div className="space-y-2">
                  {[
                    ...
                    `Learn practical ideas from ${course.speaker.name}.`,
                    `Apply the lessons to real-world projects.`,
                  ].map((point, index) => (
                    <div
                      key={index}
              ...
              <div className="mt-4 p-3 rounded-xl bg-brand-500/10 border border-brand-500/20">
                ...
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  Based on your learning history, this talk is a strong match
